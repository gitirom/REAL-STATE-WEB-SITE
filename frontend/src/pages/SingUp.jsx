...
const SingUp = () => {
    ...
    return (
        <div>
            <section>
                <h1 className='text-3xl text-center mt-6 font-bold'>Sin Up</h1>
            </section>
                        ...
                        <input  type="text" id='name' 
                            ...
                            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg ">
                                <p className="mb-6" > have a account?
                                    <Link to="/Sing-In"  
                                    className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out  ml-1"> Sin In </Link>
                                </p>
                                <p>
